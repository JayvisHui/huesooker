...
Button(gooningL,text="Quit Hueseeker",command=root.destroy,fg="red",bg="grey").pack(anchor="ne", padx= 15,expand=True) #quit button
...
Label(gooningL, fg="white",text="Insert Color Here",bg="#474747").pack(anchor='e',expand=True,fill=BOTH,padx=5) #color selection
